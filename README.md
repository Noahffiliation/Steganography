...
- Done on Ubuntu 16.04 through PuTTY on Windows 10 64-bit

- Done in C11 with GCC with flags listed below
...
- The encoded imgae can be decoded [here](https://cse.taylor.edu/~dstanley/cos232/decoder.php)
